export const accordionData = [  
  ...
  },
  {
    ...
    At the age of 19 I was accepted for Civil Engineering at the University of São Paulo. It was a very focused and intense study period, my highlight among all the mandatory courses I had to attend was definitely the C++ programming course in my first semester.
    
    Due to some health problems, I had periods of absence from college and work, which made me reflect on whether I would like to continue in the area of ​​Civil Engineering.
    
    I decided to change the subject in college and also joined the University of São Paulo in the area of ​​Physics with a focus on education.
  ...
  {
    title: 'Fun facts',
    content: 'I have the cutest brazilian dog named `Feijão` (meaning bean in english) 🐶'
  },
];